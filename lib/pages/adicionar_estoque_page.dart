...
class _AdicionarEstoquePageState extends State<AdicionarEstoquePage> {
  ...
  Future<void> _salvarEstoque() async {
    if (_formKey.currentState!.validate()) {
      ...
      final dataValidade =
          DateTime.tryParse(_dataValidadeController.text) ?? DateTime.now();
      ...
      final estoque = Estoque(
          ...
          idUsuarioEditou:
              currentUser!.id!, // Substituir pelo ID do usuário autenticado
          emailUsuarioEditou:
              currentUser!.email // Substituir pelo ID do usuário autenticado
          );
