class Estoque {
  ...
  Estoque({
    ...
    required this.emailUsuarioEditou,
    this.image,
  });
  ...
  factory Estoque.fromMap(String id, Map<String, dynamic> map) {
    return Estoque(
      ...
      emailUsuarioEditou: map['emailUsuarioEditou'],
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'emailUsuarioEditou': emailUsuarioEditou,
    };
  }
  ...
  Estoque copyWith({
    ...
    return Estoque(
      ...
      emailUsuarioEditou: emailUsuarioEditou ?? this.emailUsuarioEditou,
    );
  }
}
